 ...
 */
public class FamousStatueFragment extends Fragment {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;

    public FamousStatueFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_famous_statue, container, false);

        mRecyclerView = (RecyclerView) view.findViewById(R.id.famous_statue_list);
    ...
    public List<FamousThingsItem> getData() {
        ...
        String[] famousStatue = getActivity().getApplication().getResources().getStringArray(R.array.famour_thing_statue);

        for (int i = 0; i < famousStatue.length; i++) {
            FamousThingsItem current = new FamousThingsItem(getActivity().getApplicationContext());
            current.itemName = famousStatue[i];
            data.add(current);
        }
